...
for contract in alfred.make_contracts():
    print("alfred needs persons : "+contract)

bert = Homeowner('Bert Bertson', 'Bertlane 231', ['plumber'], specialists)
for contract in bert.make_contracts():
    print("bert needs persons: "+contract)

candice = Homeowner('Candice Candicedottir', 'Candicelane 432', ['electrician', 'painter'], specialists)
for contract in candice.make_contracts():
    print("candince needs persons: "+ contract)